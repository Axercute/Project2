...
function App() {
  ...
  const [SongSearchState, SetSongSearchState] = useState({
    songname: "",
    singername: "",
    lyrics: "",
  });
  ...
  useEffect(() => {
    console.log("handleSubmit", SongSearchState);
  }, [SongSearchState]);
  useEffect(() => {
    fetchLyricsOVH();
  }, [SongSearchState]);
    ...
    <>
      <main className="backgroundfull">
        ...
        <Routes>
          ...
          <Route
            path="/singerLogin"
            element={<SingerLogin SongList={SongList} />}
          />

          <Route
            path="/singerLogin/:songName"
            element={
              <SongDetail
                SongList={SongList}
