...
{/* Chat GBTed */}
  ...
  <p><em>No video linked yet.Add Video at the bottom</em></p>
)}
...
{/* Song Title and Artist */}
    ...
    <div className="text-2xl text-red-200 font-semibold">{renderDetails.fields.singername}</div>
    </div>

{/* Lyrics */}
    <div className=" bg-green-500 w-1/3 border-2 mx-auto rounded-4xl mb-10 overflow-scroll h-[40svh]">
    <div className="text-center text-1xl text-grey-200 font-medium" style={{ whiteSpace: "pre-wrap" }}>{renderDetails.fields.lyrics}</div>
    </div>
...
{/* Song Link Update */}
  ...
  >
      <label htmlFor="videolink" className="mr-1">Video Link:</label>
      <input 
      type ="text"
      id="videolink"
      name="videolink"
